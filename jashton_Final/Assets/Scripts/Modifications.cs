...
/*  ================================================================
    ...
    modifications: Changed the color to a light blue! Mode: Realtime, Intensity: 1.5, Multiplier: 1

    2 - fog
    modifications: Color: Gray, Mode: Exponential, Density: 0.008.

    3 - create & apply skybox and customise it (atmosphere thickness, sky tint, exposure, etc)
    modifications: 
        - Sun: High Quality
        - Sun Size Convergence: 1.56
        - Atmosphere Thickness: 1.57 
        - Ground: Greenish-Gray
        - Sky Tint: Dark Red
        - Exposure: 1.49
    ...
    modifications: I tried my best creating an actual character, it kinda looks like the robot from Wall-E a little, but I named the character "Greg". :)
        - x2 Cylinders
        - 1x Capsule
        - 1x Sphere
        - 1x Cube
    ...
    texture 1 source: https://freepbr.com/product/sand-dunes/
    texture 2 source: 
